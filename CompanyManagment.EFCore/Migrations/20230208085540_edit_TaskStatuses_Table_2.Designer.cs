...
namespace CompanyManagment.EFCore.Migrations
{
    ...
    [Migration("20230208085540_edit_TaskStatuses_Table_2")]
    partial class edit_TaskStatuses_Table_2
    {
            ...
            modelBuilder.Entity("Company.Domain.FileState.FileState", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 215, DateTimeKind.Local).AddTicks(4607),
                            FileTiming_Id = 1L,
                            State = 1,
                        ...
                        {
                            id = 2L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 220, DateTimeKind.Local).AddTicks(1114),
                            FileTiming_Id = 1L,
                            State = 2,
                        ...
                        {
                            id = 8L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 220, DateTimeKind.Local).AddTicks(1172),
                            FileTiming_Id = 1L,
                            State = 8,
                        ...
                        {
                            id = 3L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 220, DateTimeKind.Local).AddTicks(1180),
                            FileTiming_Id = 2L,
                            State = 3,
                        ...
                        {
                            id = 4L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 220, DateTimeKind.Local).AddTicks(1185),
                            FileTiming_Id = 3L,
                            State = 4,
                        ...
                        {
                            id = 5L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 220, DateTimeKind.Local).AddTicks(1190),
                            FileTiming_Id = 4L,
                            State = 5,
                        ...
                        {
                            id = 6L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 220, DateTimeKind.Local).AddTicks(1194),
                            FileTiming_Id = 5L,
                            State = 6,
                        ...
                        {
                            id = 7L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 220, DateTimeKind.Local).AddTicks(1199),
                            FileTiming_Id = 6L,
                            State = 7,
            ...
            modelBuilder.Entity("Company.Domain.FileTiming.FileTiming", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 223, DateTimeKind.Local).AddTicks(5135),
                            Deadline = 1,
                        ...
                        {
                            id = 2L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 223, DateTimeKind.Local).AddTicks(6669),
                            Deadline = 1,
                        ...
                        {
                            id = 3L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 223, DateTimeKind.Local).AddTicks(6699),
                            Deadline = 1,
                        ...
                        {
                            id = 4L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 223, DateTimeKind.Local).AddTicks(6705),
                            Deadline = 1,
                        ...
                        {
                            id = 5L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 223, DateTimeKind.Local).AddTicks(6709),
                            Deadline = 1,
                        ...
                        {
                            id = 6L,
                            CreationDate = new DateTime(2023, 2, 8, 12, 25, 39, 223, DateTimeKind.Local).AddTicks(6714),
                            Deadline = 1,
                            Tips = "پس از شرکت در جلسه اول رسیدگی ، اگر تا پایان مهلت مندرج در کادر ، دعوتنامه جدید یا دادنامه صادر نشده باشد ، نرم افزار به شما گزارش میدهد .",
                            Title = "انتظار برای دریافت دعوتنامه دوم به بعد یا دادنامه"
                        });
            ...
            modelBuilder.Entity("Company.Domain.TaskStatus.TaskStatus", b =>
                {
                    ...
                    b.Property<DateTime>("DeadlineRegDate")
                        .HasColumnType("datetime2");

                    b.Property<long>("DeadlineRegUserId")
                        .HasColumnType("bigint");

                    b.Property<string>("DoneRegDate")
                        .HasColumnType("nvarchar(max)");
