...
AMIB.persianCalendar = function (b, a) {
    var c = { inputID: "", extraInputID: "", extraInputFormat: "JD", initialDate: "", defaultDate: "", autoCreateButton: !0, divPickerClassName: "picker", btnClassName: "pcalBtn", onchange: !1 },
        d;
...
AMIB.persianCalendar.prototype.createDateTable = function (b, a, c) {
    ...
    e = d.insertRow(-1);
    h = 0;
    for (k = PERSIAN_SHORT_WEEKDAY_NAMES.length; h < k; ++h) (g = e.insertCell(-1)), g.appendChild(cTN(PERSIAN_SHORT_WEEKDAY_NAMES[h])), (g.className = "calWeekdays");
    e = d.insertRow(-1);
...
AMIB.persianCalendar.prototype.monthYearPickerClick = function (b, a, c) {
    ...
    if ((d = A$(this.inputID + "_pDatePicker")))
        b || (b = window.event), stopPropg(b), (e = A$(lastOpenPDateMonthYearID)) && e.parentNode.removeChild(e), (lastOpenPDateMonthYearID = !1), (b = c.toString() + "/" + a.toString() + "/1"), this.createDateTable(d, b, this.input.value);
};
