	...
	function iranwebsv(province) {
		with (document.getElementById('city')) {
			...
			if (province == "تهران") {
				...
				options[1] = new Option('احمدآبادمستوفي');
				options[2] = new Option('ادران');
				options[3] = new Option('اسلام آباد');
				options[4] = new Option('اسلام شهر');
				options[5] = new Option('اكبرآباد');
				options[6] = new Option('اميريه');
				options[7] = new Option('انديشه');
				options[8] = new Option('اوشان');
				options[9] = new Option('آبسرد');
				options[10] = new Option('آبعلي');
				options[11] = new Option('باغستان');
				options[12] = new Option('باقر شهر');
				options[13] = new Option('برغان');
			...
			if (province == "خوزستان") {
				...
				options[42] = new Option('c', '614911111');
			}
			if (province == "فارس") {
				options[0] = new Option('لطفا شهر را انتخاب نمایید', '0');
			...
			if (province == "چهارمحال و بختیاری") {
				options[0] = new Option('لطفا شهر را انتخاب نمایید', '0');
			...
			if (province == "کهگلویه و بویراحمد") {
				options[0] = new Option('لطفا شهر را انتخاب نمایید', '0');
